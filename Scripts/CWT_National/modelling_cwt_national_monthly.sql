...
base_query AS (
    SELECT
        ...
        CASE 
            ...
            -- When organisation name ends with Integrated Care Board, and starts with NHS, remove both. If it doesnt start with NHS just remove Integrated Care Board.
            WHEN RIGHT(ORGANISATION_NAME, 21) = 'Integrated Care Board'
                THEN 
                    CASE 
                        WHEN LEFT(ORGANISATION_NAME, 4) = 'NHS '
                            THEN SUBSTRING(ORGANISATION_NAME, 5, LENGTH(ORGANISATION_NAME) - 25) 
                        ELSE LEFT(ORGANISATION_NAME, LENGTH(ORGANISATION_NAME) - 21)
                    END
            ...
            WHEN LEFT(ORGANISATION_NAME, 4) = 'NHS ' 
                THEN SUBSTRING(ORGANISATION_NAME, 5)
            ELSE ORGANISATION_NAME
        END AS ORGANISATION_NAME_SHORT,
        ...
        CASE pmct.STANDARD
            ...
            WHEN '62 DAY' THEN '62 Day'
            ELSE pmct.STANDARD
        END AS STANDARD_BASE,
