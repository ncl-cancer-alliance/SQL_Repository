...
SELECT
   ...
   TO_DATE(TO_CHAR(dpd.DATE_OF_BIRTH, 'YYYY') || '-01-01') AS YEAR_OF_BIRTH,
    ...
    --a.IMD_QUINTILE AS RESIDENCE_LSOA_IMD_QUINTILE, -- IMD 2019
    CEIL(imd.IMD_DECILE/2) AS GP_IMD_QUINTILE, --IMD 2025. Based on GP instead of Residence as there is no LSOA in RCRD.
...
LEFT JOIN MODELLING.LOOKUP_NCL.IMD_PRACTICE_25 imd
