...
Target Output Table:
 ...
 - DEV__REPORTING.CANCER__RCRD.CANCER__RCRD__LOCAL

*/

create or replace dynamic table DEV__REPORTING.CANCER__RCRD.CANCER__RCRD__LOCAL(
	SK_PATIENT_ID,
	DATE_OF_DIAGNOSIS,
	MONTH_OF_DIAGNOSIS,
...
CASE
    ...
    WHEN rcrd.ICD10_CODE = 'C22' THEN 'Liver'
    WHEN rcrd.ICD10_CODE = 'C25' THEN 'Pancreas'
    WHEN rcrd.ICD10_CODE = 'C61' THEN 'Prostate'
    WHEN rcrd.ICD10_CODE = 'C62' THEN 'Testes'
    ...
    WHEN rcrd.ICD10_CODE BETWEEN 'C64' AND 'C68' THEN 'Urological excl. prostate'
    ...
    WHEN rcrd.ICD10_CODE IN ('C17','C23','C24','C26') THEN 'Upper GI excl. OG'
